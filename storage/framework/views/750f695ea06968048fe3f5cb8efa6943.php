            ...
            <!-- Admin Dropdown -->
             <?php $__env->slot('content', null, ['class' => '!p-0']); ?> 
                <div class="flex items-center gap-1.5 border border-b-gray-300 px-5 py-2.5 dark:border-gray-800">
                    <img
                        src="<?php echo e(url('cache/logo/bagisto.png')); ?>"
                        width="24"
                        height="24"
                    />
                ...
                <?php $__currentLoopData = menu()->getItems('admin'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $menuItem): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="group/item relative">
                        <a
                            ...
                            class="flex gap-2.5 p-1.5 items-center cursor-pointer hover:rounded-lg <?php echo e($menuItem->isActive() == 'active' ? 'bg-blue-600 rounded-lg' : ' hover:bg-gray-100 hover:dark:bg-gray-950'); ?> peer"
                        >
                        ...
                        <?php if($menuItem->haveChildren()): ?>
                            <div class="<?php echo e($menuItem->isActive() ? ' !grid bg-gray-100 dark:bg-gray-950' : ''); ?> hidden min-w-[180px] ltr:pl-10 rtl:pr-10 pb-2 rounded-b-lg z-[100]">
...
<?php if (! $__env->hasRenderedOnce('f1520acf-50c4-47fe-8e8a-83132cdfc321')): $__env->markAsRenderedOnce('f1520acf-50c4-47fe-8e8a-83132cdfc321');
...
<?php $__env->stopPush(); endif; ?><?php /**PATH /var/www/html/Thames/thamescc-backend/packages/Webkul/Admin/src/Providers/../Resources/views/components/layouts/header/index.blade.php ENDPATH**/ ?>