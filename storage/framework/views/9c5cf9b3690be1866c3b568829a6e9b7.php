<?php if(Webkul\Product\Helpers\ProductType::hasVariants($product->type)): ?>
                            ...
                            >
                                ...
                                <td class="px-4 py-2">
                                    <button
                                        ...
                                        @click="addToCart({ productId: <?php echo e($product->id); ?>, optionId: option.id ,attribute:attribute })"
                                    >
                                        Add to Cart
                                    </button>
                                </td>
    ...
    <?php $__env->stopPush(); ?>
<?php endif; ?><?php /**PATH /var/www/html/Thames/thamescc-backend/packages/Webkul/Shop/src/Providers/../Resources/views/products/view/types/configurable.blade.php ENDPATH**/ ?>