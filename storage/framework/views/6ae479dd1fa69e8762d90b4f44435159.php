...
<?php $component->withAttributes([]); ?>
    ...
    <div class="flex items-center justify-between gap-4 max-sm:flex-wrap">
        ...
        <div class="flex items-center gap-x-2.5">
            <?php echo view_render_event('bagisto.admin.catalog.categories.index.create-button.before'); ?>
            ...
            <?php echo view_render_event('bagisto.admin.catalog.categories.index.create-button.after'); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'admin::components.datagrid.index','data' => ['src' => route('admin.catalog.categories.index')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['src' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route('admin.catalog.categories.index'))]); ?>
...
<?php endif; ?>
<?php /**PATH /var/www/html/Thames/thamescc-backend/packages/Webkul/Admin/src/Providers/../Resources/views/catalog/categories/index.blade.php ENDPATH**/ ?>