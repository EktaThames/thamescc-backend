...
<?php if (! $__env->hasRenderedOnce('ed0053a3-e3e9-406f-8acc-a84c7cba6ca0')): $__env->markAsRenderedOnce('ed0053a3-e3e9-406f-8acc-a84c7cba6ca0');
            ...
            <div class="grid gap-4 border-b px-4 py-2 dark:border-gray-800">
                <div class="flex justify-between gap-2">
                    ...
                    <div class="flex flex-col justify-between gap-1">
                        ...
                        <!-- Total Orders -->
                        <p class="text-right text-xs font-semibold text-gray-400 dark:text-white">
                            {{ "<?php echo app('translator')->get('admin::app.dashboard.index.unique-visitors'); ?>".replace(':count', report.statistics.unique.current ?? 0) }}
                        </p>
                    </div>
                </div>
...
<?php $__env->stopPush(); endif; ?><?php /**PATH /var/www/html/Thames/thamescc-backend/packages/Webkul/Admin/src/Providers/../Resources/views/dashboard/total-visitors.blade.php ENDPATH**/ ?>