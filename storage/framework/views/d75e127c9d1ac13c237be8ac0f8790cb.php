...
<?php if (! $__env->hasRenderedOnce('26613cea-9e09-4cfa-b359-3debf35731fd')): $__env->markAsRenderedOnce('26613cea-9e09-4cfa-b359-3debf35731fd');
...
<?php endif; ?>
                ...
                <div class="ltr:pl-2.5 rtl:pr-2.5">
                    <p class="text-sm font-light text-gray-800 dark:text-white">
                        {{ "<?php echo app('translator')->get('admin::app.components.datagrid.toolbar.length-of'); ?>".replace(':length', massActions.indices.length) }}

                        {{ "<?php echo app('translator')->get('admin::app.components.datagrid.toolbar.selected'); ?>".replace(':total', available.meta.total) }}
                    </p>
                </div>
            </div>
        </slot>
...
<?php /**PATH /var/www/html/Thames/thamescc-backend/packages/Webkul/Admin/src/Providers/../Resources/views/components/datagrid/toolbar/mass-action.blade.php ENDPATH**/ ?>