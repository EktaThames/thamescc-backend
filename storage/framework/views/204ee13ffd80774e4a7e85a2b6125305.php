...
<?php if (! $__env->hasRenderedOnce('cc576a4f-4da7-4e52-9d91-617ab93fcb13')): $__env->markAsRenderedOnce('cc576a4f-4da7-4e52-9d91-617ab93fcb13');
                ...
                <div class="grid gap-3">
                    <div class="flex items-center justify-between">
                        <p class="text-xl font-medium dark:text-white">
                            <?php echo app('translator')->get('admin::app.components.products.search.title'); ?>
                        </p>
                        ...
                        <div
                            ...
                            @click="addSelected"
                        >
                            <?php echo app('translator')->get('admin::app.components.products.search.add-btn'); ?>
                        </div>
                    </div>
                    ...
                    >
                        ...
                        <div class="flex gap-2.5">
                            ...
                            >
                                <template v-if="! product.images.length">
                                    ...
                                    <p class="absolute bottom-1.5 w-full text-center text-[6px] font-semibold text-gray-400">
                                        <?php echo app('translator')->get('admin::app.components.products.search.product-image'); ?>
                                    </p>
                                </template>
                            ...
                            <div class="grid place-content-start gap-1.5">
                                ...
                                <p class="text-gray-600 dark:text-gray-300">
                                    {{ "<?php echo app('translator')->get('admin::app.components.products.search.sku'); ?>".replace(':sku', product.sku) }}
                                </p>
                            </div>
                        </div>
                        ...
                        <div class="grid place-content-start gap-1 text-right">
                            ...
                            <p class="text-green-600">
                                {{ "<?php echo app('translator')->get('admin::app.components.products.search.qty'); ?>".replace(':qty', totalQty(product)) }}
                            </p>
                        </div>
                    </div>
                </div>
                ...
                >
                    ...
                    <div class="flex flex-col items-center gap-1.5">
                        <p class="text-base font-semibold text-gray-400">
                            <?php echo app('translator')->get('admin::app.components.products.search.empty-title'); ?>
                        </p>

                        <p class="text-gray-400">
                            <?php echo app('translator')->get('admin::app.components.products.search.empty-info'); ?>
                        </p>
                    </div>
                </div>
             <?php $__env->endSlot(); ?>
...
<?php $__env->stopPush(); endif; ?><?php /**PATH /var/www/html/Thames/thamescc-backend/packages/Webkul/Admin/src/Providers/../Resources/views/components/products/search.blade.php ENDPATH**/ ?>