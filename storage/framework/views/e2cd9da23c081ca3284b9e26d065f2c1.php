...
<?php $component->withAttributes([]); ?>
    ...
    <div class="flex flex-1 flex-col gap-4 max-xl:flex-auto">
        <!-- Sales Section -->
        <?php echo $__env->make('admin::reporting.sales.total-sales', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
        ...
        <div class="flex justify-between gap-4 flex-1 [&>*]:flex-1 max-xl:flex-auto">
            ...
            <?php echo $__env->make('admin::reporting.sales.purchase-funnel', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>

            <!-- Abandoned Carts Section -->
            <?php echo $__env->make('admin::reporting.sales.abandoned-carts', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
        </div>

        <!-- Total Orders and Average Order Value Sections Container -->
        <div class="flex justify-between gap-4 flex-1 [&>*]:flex-1 max-xl:flex-auto">
            <!-- Total Orders Section -->
            <?php echo $__env->make('admin::reporting.sales.total-orders', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>

            <!-- Average Order Value Section -->
            <?php echo $__env->make('admin::reporting.sales.average-order-value', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
        </div>

        <!-- Tax Collected and Shipping Collected Sections Container -->
        <div class="flex justify-between gap-4 flex-1 [&>*]:flex-1 max-xl:flex-auto">
            <!-- Tax Collected Section -->
            <?php echo $__env->make('admin::reporting.sales.tax-collected', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>

            <!-- Shipping Collected Section -->
            <?php echo $__env->make('admin::reporting.sales.shipping-collected', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
        </div>

        <!-- Refunds and Top Payment Methods Sections Container -->
        <div class="flex justify-between gap-4 flex-1 [&>*]:flex-1 max-xl:flex-auto">
            <!-- Refunds Section -->
            <?php echo $__env->make('admin::reporting.sales.total-refunds', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>

            <!-- Top Payment Methods Section -->
            <?php echo $__env->make('admin::reporting.sales.top-payment-methods', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
        </div>
    </div>

    <?php if (! $__env->hasRenderedOnce('93513707-955a-41c8-ac2e-9e8e268c5513')): $__env->markAsRenderedOnce('93513707-955a-41c8-ac2e-9e8e268c5513');
...
<?php endif; ?>
<?php /**PATH /var/www/html/Thames/thamescc-backend/packages/Webkul/Admin/src/Providers/../Resources/views/reporting/sales/index.blade.php ENDPATH**/ ?>