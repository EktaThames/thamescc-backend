...
<?php if($customization): ?>
    <div class="container mt-20 max-lg:px-8 max-md:mt-10 max-md:px-4" style="padding: 15px;">
...
<?php echo view_render_event('bagisto.shop.layout.features.after'); ?><?php /**PATH C:\xampp\htdocs\backendbagisto\thamescc-backend\packages\Webkul\Shop\src/resources/views/components/layouts/services.blade.php ENDPATH**/ ?>