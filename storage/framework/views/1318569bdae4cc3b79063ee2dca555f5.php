...
<?php if (! $__env->hasRenderedOnce('b1cb30d3-f8f9-4c76-88ca-1d6fd0054d68')): $__env->markAsRenderedOnce('b1cb30d3-f8f9-4c76-88ca-1d6fd0054d68');
$__env->startPush('scripts'); ?>
    ...
    <script type="module">
        app.component('v-modal-confirm', {
            ...
            methods: {
                open({
                    title = "<?php echo app('translator')->get('admin::app.components.modal.confirm.title'); ?>",
                    message = "<?php echo app('translator')->get('admin::app.components.modal.confirm.message'); ?>",
                    options = {
                        btnDisagree: "<?php echo app('translator')->get('admin::app.components.modal.confirm.disagree-btn'); ?>",
                        btnAgree: "<?php echo app('translator')->get('admin::app.components.modal.confirm.agree-btn'); ?>",
                    },
                    agree = () => {},
                    disagree = () => {},
                }) {
...
<?php $__env->stopPush(); endif; ?><?php /**PATH /var/www/html/Thames/thamescc-backend/packages/Webkul/Admin/src/Providers/../Resources/views/components/modal/confirm.blade.php ENDPATH**/ ?>