...
<?php if (! $__env->hasRenderedOnce('84e5f8d5-f652-4185-939b-4508fa2826d9')): $__env->markAsRenderedOnce('84e5f8d5-f652-4185-939b-4508fa2826d9');
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'admin::components.form.control-group.control','data' => ['type' => 'select','name' => 'model','rules' => 'required','vModel' => 'ai.model','label' => trans('admin::app.components.tinymce.ai-generation.model')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['type' => 'select','name' => 'model','rules' => 'required','v-model' => 'ai.model','label' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(trans('admin::app.components.tinymce.ai-generation.model'))]); ?>
                                <option value="gpt-4-turbo">
                                    <?php echo app('translator')->get('admin::app.components.tinymce.ai-generation.gpt-4-turbo'); ?>
                                </option>

                                <option value="gpt-4o">
                                    <?php echo app('translator')->get('admin::app.components.tinymce.ai-generation.gpt-4o'); ?>
                                </option>

                                <option value="gpt-4o-mini">
                                    <?php echo app('translator')->get('admin::app.components.tinymce.ai-generation.gpt-4o-mini'); ?>
                                </option>

                                <option value="gemini-2.0-flash">
                                    <?php echo app('translator')->get('admin::app.components.tinymce.ai-generation.gemini-2-0-flash'); ?>
                                </option>

                                <option value="deepseek-r1:8b">
                                    <?php echo app('translator')->get('admin::app.components.tinymce.ai-generation.deepseek-r1-8b'); ?>
                                </option>

                                <option value="llama3-8b-8192">
                                    <?php echo app('translator')->get('admin::app.components.tinymce.ai-generation.llama-groq'); ?>
                                </option>

                                <option value="llama3.2:3b">
                                    <?php echo app('translator')->get('admin::app.components.tinymce.ai-generation.llama3-2-3b'); ?>
                                </option>

                                <option value="llama3.2:1b">
                                    <?php echo app('translator')->get('admin::app.components.tinymce.ai-generation.llama3-2-1b'); ?>
                                </option>

                                <option value="llama3.1:8b">
                                    <?php echo app('translator')->get('admin::app.components.tinymce.ai-generation.llama3-1-8b'); ?>
                                </option>

                                <option value="llama3:8b">
                                    <?php echo app('translator')->get('admin::app.components.tinymce.ai-generation.llama3-8b'); ?>
                                </option>

                                <option value="llava:7b">
                                    <?php echo app('translator')->get('admin::app.components.tinymce.ai-generation.llava-7b'); ?>
                                </option>

                                <option value="vicuna:13b">
                                    <?php echo app('translator')->get('admin::app.components.tinymce.ai-generation.vicuna-13b'); ?>
                                </option>

                                <option value="vicuna:7b">
                                    <?php echo app('translator')->get('admin::app.components.tinymce.ai-generation.vicuna-7b'); ?>
                                </option>

                                <option value="qwen2.5:14b">
                                    <?php echo app('translator')->get('admin::app.components.tinymce.ai-generation.qwen2-5-14b'); ?>
                                </option>

                                <option value="qwen2.5:7b">
                                    <?php echo app('translator')->get('admin::app.components.tinymce.ai-generation.qwen2-5-7b'); ?>
                                </option>

                                <option value="qwen2.5:3b">
                                    <?php echo app('translator')->get('admin::app.components.tinymce.ai-generation.qwen2-5-3b'); ?>
                                </option>

                                <option value="qwen2.5:1.5b">
                                    <?php echo app('translator')->get('admin::app.components.tinymce.ai-generation.qwen2-5-1-5b'); ?>
                                </option>

                                <option value="qwen2.5:0.5b">
                                    <?php echo app('translator')->get('admin::app.components.tinymce.ai-generation.qwen2-5-0-5b'); ?>
                                </option>

                                <option value="mistral:7b">
                                    <?php echo app('translator')->get('admin::app.components.tinymce.ai-generation.mistral-7b'); ?>
                                </option>

                                <option value="starling-lm:7b">
                                    <?php echo app('translator')->get('admin::app.components.tinymce.ai-generation.starling-lm-7b'); ?>
                                </option>

                                <option value="phi3.5">
                                    <?php echo app('translator')->get('admin::app.components.tinymce.ai-generation.phi3-5'); ?>
                                </option>

                                <option value="orca-mini">
                                    <?php echo app('translator')->get('admin::app.components.tinymce.ai-generation.orca-mini'); ?>
                                </option>
                             <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
        ...
        app.component('v-tinymce', {
            ...
            methods: {
                    ...
                    let tinyMCEHelper = {
                        ...
                        uploadImageHandler: function(config, blobInfo, resolve, reject, progress) {
                            ...
                            xhr.onload = function() {
                                ...
                                if (xhr.status === 403) {
                                    reject("<?php echo app('translator')->get('admin::app.error.tinymce.http-error'); ?>", {
                                        remove: true
                                    });
                                ...
                                if (! json || typeof json.location != 'string') {
                                    reject("<?php echo app('translator')->get('admin::app.error.tinymce.invalid-json'); ?>" + xhr.responseText);
                            ...
                            xhr.onerror = (()=>reject("<?php echo app('translator')->get('admin::app.error.tinymce.upload-failed'); ?>"));
                ...
                generate(params, { resetForm, resetField, setErrors }) {
                    ...
                    this.$axios.post("<?php echo e(route('admin.magic_ai.content')); ?>", {
...
<?php $__env->stopPush(); endif; ?><?php /**PATH /var/www/html/Thames/thamescc-backend/packages/Webkul/Admin/src/Providers/../Resources/views/components/tinymce/index.blade.php ENDPATH**/ ?>