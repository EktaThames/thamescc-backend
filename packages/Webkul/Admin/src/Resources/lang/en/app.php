...
'accept_marketing'          => 'Accepted Marketing',
    ...
    'footer-settings' => [
        'edit' => [
            ...
            'description' => 'Manage your website footer content and links',
            'save-btn' => 'Save Settings',
            'about' => 'About Section',
            'about-text' => 'About Text',
            'about-text-placeholder' => 'Enter your company description or about text',
            'social-media' => 'Social Media Links',
            'twitter-url' => 'Twitter URL',
            'twitter-url-placeholder' => 'https://twitter.com/yourcompany',
            'instagram-url' => 'Instagram URL',
            'instagram-url-placeholder' => 'https://instagram.com/yourcompany',
            'facebook-url' => 'Facebook URL',
            'facebook-url-placeholder' => 'https://facebook.com/yourcompany',
            'contact-information' => 'Contact Information',
            'contact-address' => 'Contact Address',
            'contact-address-placeholder' => 'Enter your business address',
            'contact-phone' => 'Contact Phone',
            'contact-phone-placeholder' => '+1 (555) 123-4567',
            'contact-email' => 'Contact Email',
            'contact-email-placeholder' => 'contact@yourcompany.com',
            'copyright' => 'Copyright Information',
            'copyright-text' => 'Copyright Text',
            'copyright-text-placeholder' => '© 2024 Your Company. All rights reserved.',
            'help-links' => 'Help Links',
            'important-links' => 'Important Information Links',
            'add-link' => 'Add Link',
