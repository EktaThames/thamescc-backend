...
<footer style="background:#232221; color:#fff; padding:40px 0 0 0; font-family:inherit;">
    <div style="display:flex; flex-wrap:wrap; justify-content:space-between; max-width: 100%; margin:0 auto; gap:40px;padding: 0 60px;">
        <div style="flex:1; min-width:220px;">
            ...
            <p style="margin-top:10px;">{!! $footer?->about_text !!}</p>
            <div style="margin-top:20px;">
                <span style="font-weight:bold;">Socials</span>
                <div style="display:flex; gap:15px; margin-top:10px;">
                @if($footer?->twitter)
                <a href="{{ $footer->twitter }}" target="_blank" style="color:#fff; font-size:22px;">
            ...
            @endif
            @if($footer?->instagram)
                <a href="{{ $footer->instagram }}" target="_blank" style="color:#fff; font-size:22px;">
            ...
            @endif
            @if($footer?->facebook)
                <a href="{{ $footer->facebook }}" target="_blank" style="color:#fff; font-size:22px;">
                ...
                <ul style="list-style:none; padding:0; margin:0;">
                    @foreach ($footer->help_links as $link)
                        <li style="margin-bottom:10px;">
                            <a href="{{ $link['url'] }}" style="color:#fff; text-decoration:none;">{{ $link['title'] }}</a>
                        </li>
                    @endforeach
                </ul>
            @endif
        ...
        <div style="flex:1; min-width:220px;">
            ...
            <div style="margin-bottom: 10px;display: flex;gap: 10px;">
                ...
                <a href="https://www.google.com/maps/search/?api=1&query={{ urlencode($footer?->contact_address) }}" target="_blank" style="color:#fff; text-decoration:none;">
            ...
            <div style="margin-bottom: 10px;display: flex;gap: 10px;">
                ...
                <a href="tel:{{ $footer?->contact_phone }}" style="color:#fff; text-decoration:none;">
            ...
            <div style="margin-bottom: 10px;display: flex;gap: 10px;">
                ...
                <a href="mailto:{{ $footer?->contact_email }}" style="color:#fff; text-decoration:none;">
