	...
	<div class="container mt-20 max-1180:px-5 max-md:mt-12">
		...
		<div class="m-auto w-full max-w-[870px] rounded-xl border border-zinc-200 p-16 px-[90px] max-md:px-8 max-md:py-8 max-sm:border-none max-sm:p-0">
            <x-shop::tabs position="center">
                <x-shop::tabs.item
                    :title="trans('shop::app.customers.signup-form.normal-customer')"
                    :is-selected="true"
                >
                    <h1 class="mb-4 font-dmserif text-4xl max-md:text-3xl max-sm:text-xl">
                        @lang('shop::app.customers.signup-form.page-title')
                    </h1>
                    <p class="text-xl text-zinc-500 max-sm:text-sm">
                ...
                <x-shop::tabs.item
                    :title="trans('shop::app.customers.signup-form.trade-customer')"
                >
                    <h1 class="mb-4 font-dmserif text-4xl max-md:text-3xl max-sm:text-xl">
                        @lang('shop::app.customers.signup-form.trade-customer-title')
                    </h1>
                    <p class="text-xl text-zinc-500 max-sm:text-sm">
                        @lang('shop::app.customers.signup-form.form-signup-text')
                    </p>
                    ...
                    <div class="mt-14 rounded max-sm:mt-8">
                        <x-shop::form :action="route('shop.customers.register.store')">
                            <input type="hidden" name="customer_type" value="trade">

                            {!! view_render_event('bagisto.shop.customers.signup_form_controls.before') !!}

                            <x-shop::form.control-group>
                                <x-shop::form.control-group.label class="required">@lang('shop::app.customers.signup-form.first-name')</x-shop::form.control-group.label>
                                <x-shop::form.control-group.control type="text" name="first_name" rules="required" :value="old('first_name')" :label="trans('shop::app.customers.signup-form.first-name')" :placeholder="trans('shop::app.customers.signup-form.first-name')" />
                                <x-shop::form.control-group.error control-name="first_name" />
                            </x-shop::form.control-group>

                            <x-shop::form.control-group>
                                <x-shop::form.control-group.label class="required">@lang('shop::app.customers.signup-form.last-name')</x-shop::form.control-group.label>
                                <x-shop::form.control-group.control type="text" name="last_name" rules="required" :value="old('last_name')" :label="trans('shop::app.customers.signup-form.last-name')" :placeholder="trans('shop::app.customers.signup-form.last-name')" />
                                <x-shop::form.control-group.error control-name="last_name" />
                            </x-shop::form.control-group>

                            <x-shop::form.control-group>
                                <x-shop::form.control-group.label class="required">@lang('shop::app.customers.signup-form.email')</x-shop::form.control-group.label>
                                <x-shop::form.control-group.control type="email" name="email" rules="required|email" :value="old('email')" :label="trans('shop::app.customers.signup-form.email')" placeholder="email@example.com" />
                                <x-shop::form.control-group.error control-name="email" />
                            </x-shop::form.control-group>

                            <x-shop::form.control-group>
                                <x-shop::form.control-group.label class="required">@lang('shop::app.customers.signup-form.password')</x-shop::form.control-group.label>
                                <x-shop::form.control-group.control type="password" name="password" rules="required|min:6" ref="password" :label="trans('shop::app.customers.signup-form.password')" :placeholder="trans('shop::app.customers.signup-form.password')" />
                                <x-shop::form.control-group.error control-name="password" />
                            </x-shop::form.control-group>

                            <x-shop::form.control-group>
                                <x-shop::form.control-group.label class="required">@lang('shop::app.customers.signup-form.confirm-pass')</x-shop::form.control-group.label>
                                <x-shop::form.control-group.control type="password" name="password_confirmation" rules="confirmed:@password" :label="trans('shop::app.customers.signup-form.confirm-pass')" :placeholder="trans('shop::app.customers.signup-form.confirm-pass')" />
                                <x-shop::form.control-group.error control-name="password_confirmation" />
                            </x-shop::form.control-group>
                            ...
                            <x-shop::form.control-group>
                                ...
                                <x-shop::form.control-group.control type="text" name="business_trading_name" class="px-6 py-4" rules="required" :value="old('business_trading_name', $customer->business_trading_name ?? '')" />
                            ...
                            <x-shop::form.control-group>
                                ...
                                <select name="type_of_business" class="custom-select w-full rounded-lg border border-zinc-200 px-4 py-3 text-sm text-gray-600 transition-all hover:border-gray-400" required>
                            ...
                            <x-shop::form.control-group>
                                ...
                                <select name="entity" class="custom-select w-full rounded-lg border border-zinc-200 px-4 py-3 text-sm text-gray-600 transition-all hover:border-gray-400" required>
                                    <option value="">-- Select --</option>
                            ...
                            <x-shop::form.control-group>
                                ...
                                <x-shop::form.control-group.control type="text" name="trading_street" rules="required" :value="old('trading_street', $customer->trading_street ?? '')" />
                            </x-shop::form.control-group>

                            <x-shop::form.control-group>
                                <x-shop::form.control-group.label>Address Line 2</x-shop::form.control-group.label>
                                <x-shop::form.control-group.control type="text" name="trading_address_line_2" :value="old('trading_address_line_2', $customer->trading_address_line_2 ?? '')" />
                            </x-shop::form.control-group>

                            <x-shop::form.control-group>
                                <x-shop::form.control-group.label class="required">City</x-shop::form.control-group.label>
                                <x-shop::form.control-group.control type="text" name="trading_city" rules="required" :value="old('trading_city', $customer->trading_city ?? '')" />
                            </x-shop::form.control-group>

                            <x-shop::form.control-group>
                                <x-shop::form.control-group.label class="required">Postal Code</x-shop::form.control-group.label>
                                <x-shop::form.control-group.control type="text" name="trading_postal_code" rules="required" :value="old('trading_postal_code', $customer->trading_postal_code ?? '')" />
                            </x-shop::form.control-group>

                            <x-shop::form.control-group>
                                <x-shop::form.control-group.label class="required">Country</x-shop::form.control-group.label>
                                <x-shop::form.control-group.control type="text" name="trading_country" rules="required" :value="old('trading_country', $customer->trading_country ?? '')" />
                            </x-shop::form.control-group>

                            <x-shop::form.control-group>
                                <x-shop::form.control-group.label class="required">Phone</x-shop::form.control-group.label>
                                <x-shop::form.control-group.control type="text" name="trading_phone" rules="required" :value="old('trading_phone', $customer->trading_phone ?? '')" />
                            </x-shop::form.control-group>

                            <x-shop::form.control-group>
                                <x-shop::form.control-group.label class="required">Trading Email</x-shop::form.control-group.label>
                                <x-shop::form.control-group.control type="email" name="trading_email" rules="required|email" :value="old('trading_email', $customer->trading_email ?? '')" />
                            </x-shop::form.control-group>

                            {{-- Owner Name --}}
                            <x-shop::form.control-group>
                                <x-shop::form.control-group.label>Owner First Name</x-shop::form.control-group.label>
                                <x-shop::form.control-group.control type="text" name="owner_first_name" :value="old('owner_first_name', $customer->owner_first_name ?? '')" />
                            </x-shop::form.control-group>

                            <x-shop::form.control-group>
                                <x-shop::form.control-group.label>Owner Last Name</x-shop::form.control-group.label>
                                <x-shop::form.control-group.control type="text" name="owner_last_name" :value="old('owner_last_name', $customer->owner_last_name ?? '')" />
                            </x-shop::form.control-group>

                            {{-- Owner Address (if different) --}}
                            <x-shop::form.control-group>
                                <x-shop::form.control-group.label>Owner Street Address</x-shop::form.control-group.label>
                                <x-shop::form.control-group.control type="text" name="owner_street" :value="old('owner_street', $customer->owner_street ?? '')" />
                            </x-shop::form.control-group>

                            <x-shop::form.control-group>
                                <x-shop::form.control-group.label>Owner Address Line 2</x-shop::form.control-group.label>
                                <x-shop::form.control-group.control type="text" name="owner_address_line_2" :value="old('owner_address_line_2', $customer->owner_address_line_2 ?? '')" />
                            </x-shop::form.control-group>

                            <x-shop::form.control-group>
                                <x-shop::form.control-group.label>Owner City</x-shop::form.control-group.label>
                                <x-shop::form.control-group.control type="text" name="owner_city" :value="old('owner_city', $customer->owner_city ?? '')" />
                            </x-shop::form.control-group>

                            <x-shop::form.control-group>
                                <x-shop::form.control-group.label>Owner Postal Code</x-shop::form.control-group.label>
                                <x-shop::form.control-group.control type="text" name="owner_postal_code" :value="old('owner_postal_code', $customer->owner_postal_code ?? '')" />
                            </x-shop::form.control-group>

                            <x-shop::form.control-group>
                                <x-shop::form.control-group.label>Owner Country</x-shop::form.control-group.label>
                                <x-shop::form.control-group.control type="text" name="owner_country" :value="old('owner_country', $customer->owner_country ?? '')" />
                            </x-shop::form.control-group>

                            <x-shop::form.control-group>
                                <x-shop::form.control-group.label class="required">Owner Phone</x-shop::form.control-group.label>
                                <x-shop::form.control-group.control type="text" name="owner_phone" rules="required" :value="old('owner_phone', $customer->owner_phone ?? '')" />
                            </x-shop::form.control-group>

                            <x-shop::form.control-group>
                                <x-shop::form.control-group.label class="required">Owner Email</x-shop::form.control-group.label>
                                <x-shop::form.control-group.control type="email" name="owner_email" rules="required|email" :value="old('owner_email', $customer->owner_email ?? '')" />
                            </x-shop::form.control-group>

                            <x-shop::form.control-group>
                                <x-shop::form.control-group.label class="required">VAT Registration Number</x-shop::form.control-group.label>
                                <x-shop::form.control-group.control type="text" name="vat_number" rules="required" :value="old('vat_number', $customer->vat_number ?? '')" />
                            </x-shop::form.control-group>
                            ...
                            <x-shop::form.control-group>
                                ...
                                <x-shop::form.control-group.control type="text" name="eoid" :value="old('eoid', $customer->eoid ?? '')" />
                            </x-shop::form.control-group>

                            <x-shop::form.control-group>
                                <x-shop::form.control-group.label>FID</x-shop::form.control-group.label>
                                <x-shop::form.control-group.control type="text" name="fid" :value="old('fid', $customer->fid ?? '')" />
                            </x-shop::form.control-group>

                            <x-shop::form.control-group>
                                <x-shop::form.control-group.label>Company Registration Number</x-shop::form.control-group.label>
                                <x-shop::form.control-group.control type="text" name="company_registration_number" :value="old('company_registration_number', $customer->company_registration_number ?? '')" />
                            </x-shop::form.control-group>

                            <x-shop::form.control-group>
                                <x-shop::form.control-group.label>Company Registered Street Address</x-shop::form.control-group.label>
                                <x-shop::form.control-group.control type="text" name="registered_street" :value="old('registered_street', $customer->registered_street ?? '')" />
                            </x-shop::form.control-group>

                            <x-shop::form.control-group>
                                <x-shop::form.control-group.label>Apartment</x-shop::form.control-group.label>
                                <x-shop::form.control-group.control type="text" name="registered_apartment" :value="old('registered_apartment', $customer->registered_apartment ?? '')" />
                            </x-shop::form.control-group>

                            <x-shop::form.control-group>
                                <x-shop::form.control-group.label>City</x-shop::form.control-group.label>
                                <x-shop::form.control-group.control type="text" name="registered_city" :value="old('registered_city', $customer->registered_city ?? '')" />
                            </x-shop::form.control-group>

                            <x-shop::form.control-group>
                                <x-shop::form.control-group.label>Postal Code</x-shop::form.control-group.label>
                                <x-shop::form.control-group.control type="text" name="registered_postal" :value="old('registered_postal', $customer->registered_postal ?? '')" />
                            </x-shop::form.control-group>

                            <x-shop::form.control-group>
                                <x-shop::form.control-group.label>Country</x-shop::form.control-group.label>
                                <x-shop::form.control-group.control type="text" name="registered_country" :value="old('registered_country', $customer->registered_country ?? '')" />
                            </x-shop::form.control-group>

                            <x-shop::form.control-group>
                                <x-shop::form.control-group.label class="required">Referred By</x-shop::form.control-group.label>
                                <x-shop::form.control-group.control type="text" name="referred_by" rules="required" :value="old('referred_by', $customer->referred_by ?? '')" />
                            </x-shop::form.control-group>
